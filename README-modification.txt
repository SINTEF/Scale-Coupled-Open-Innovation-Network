...
1. Create an issue with a detailed description of what you plan to change (https://github.com/SINTEF/Scale-Coupled-Open-Innovation-Network/issues) and assign the issue to yourself
2. Check with Carlos (cr.arnaiz@upm.es) to agree on a timeframe for implementation and get write access to the repository
